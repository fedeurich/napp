      ...
      {loading ? (
        ...
        <div className="justify-content-center align-items-center">
          <div className="card-header py-3">
            <h5 className="m-0 font-weight-bold text-gray-800">{latestProduct.NameProduct}</h5>
          </div>
          <div className="card-body">
            <p className="h5 mb-0 font-weight-bold text-gray-800">ID: {latestProduct.IDProduct}</p>
            <p className="h5 mb-0 font-weight-bold text-gray-800">Precio: ${latestProduct.Price}</p>
            <p className="h5 mb-0 font-weight-bold text-gray-800">Descripción: {latestProduct.DescriptionProduct}</p>
